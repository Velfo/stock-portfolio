...
Once you are on the landing page click 'Click to Display Dashboard' button to display the shares. If you do not see two shares dispalyed then refresh the page a couple of times. The Quandle API sometimes give 429 CORS error.  
